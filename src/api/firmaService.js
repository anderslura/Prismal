...
export async function lagreFirma({ firmanavn, telefon, epost, adresse, orgnr, nettside, logoUrl, mvaPliktig, facebookNavn, facebookUrl }) {
  ...
  const { error } = await supabase
    ...
    .upsert({
      ...
      facebook_navn: facebookNavn || null,
